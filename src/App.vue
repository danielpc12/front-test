         ...
         <div class="row">
            <div class="col-md-6 mx-auto" style="width: 10%; left: 0%; padding-right: 0px; padding-left: 0px; max-height: 100%;">
               ...
               <ul class="list-group" style="padding-left: 0px; ">
                  ...
                  <li class="list-group-item list-group-item-action rgba-red-strong" v-for="n in listNodes" :key="n" draggable="true" :data-node="n.item" @dragstart="drag($event)" style="-webkit-transition-duration: 0.2s;
   ...
   setup() {
     ...
     const toggleModal = () => {
      ...
      const loadNodes = (event)=>{
         ...
         editor.value = new Drawflow(id, Vue, internalInstance.appContext.app._context);
         //console.log(workspaceGenerator)
